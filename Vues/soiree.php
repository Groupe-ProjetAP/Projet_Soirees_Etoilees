        ...
        foreach ($listeSoirées as $uneSoirée) {
            echo "<tr>";
                ...
                echo "<td>";
                    ...
                    echo " ";
                    echo "<a class='btn' href='index.php?controleur=Soiree&action=modifierSoiree&nom=" . $uneSoirée->getNom()
                                                                                        . "&nbPlace=" . $uneSoirée->getNbPlace() 
                                                                                        . "&date=" . $uneSoirée->getDateSoiree()
                                                                                        . "&idSoiré=". $uneSoirée->getId() 
                                                                                        . "'>Modifier</a>";
                echo "</td>";
            echo "</tr>";
        }
